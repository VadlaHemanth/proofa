...
export const SafetyCrisisBanner: React.FC = () => {
  return (
    <div className="bg-slate-50 border-2 border-slate-300/80 rounded-2xl p-5 shadow-soft space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1 text-xs">
        <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200 flex items-center space-x-2">
          <PhoneCall className="w-4 h-4 text-slate-600 shrink-0" />
          <div>
            <p className="font-bold text-slate-900">Tele-MANAS (Govt of India)</p>
            <p className="text-slate-700 font-extrabold text-sm">14416 / 1800 891 4416</p>
        ...
        <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200 flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-slate-700 font-extrabold text-sm">1800-599-0019</p>
        ...
        <div className="bg-white/80 p-2.5 rounded-xl border border-slate-200 flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-slate-700 font-extrabold text-sm">+91 9999 666 555</p>
            <p className="text-[10px] text-slate-500">Free 24x7 Chat & Call</p>
          </div>
        </div>
      </div>

      <p className="text-[11px] text-slate-600/90 italic">
